...
datasets = {
    "PEEK": {"Interfacial Properties with Carbon Fiber (IFSS, MPa)": (80), "Coefficient Thermal Expansion (CTE) (µstrain/°C)": (50, 60), "Glass Transition Temperature (°C)": (143, 157), "Cost (USD/kg)": (50, 110), "Strength (GPa)": (3.79, 3.95), "Shrinkage (%)": (1.00, 1.21), "Density (kg/m³)": (1300, 1320)},
