...
datasets = {
    ...
    "PEEK ARAMID FIBER FILLED": {"Cost (USD/kg)": (54.50, 81.75), "Coefficient of Thermal Expansion (CTE) (µstrain/°C)": (5, 10), "Interfacial Properties with Carbon Fiber (IFSS, MPa)": (80, 80), "Shrinkage (%)": (0.05, 1.5), "Glass Transition Temperature (°C)": (143, 170), "Tensile Strength (MPa)": (75, 193), "Flexural Modulus (GPa)": (4.83, 22.8), "Density (kg/m3)": (1310, 1500)},
    ...
    "PPS UNFILLED": {"Cost (USD/kg)": (7.63, 13.08), "Coefficient of Thermal Expansion (CTE) (µstrain/°C)": (15, 36), "Interfacial Properties with Carbon Fiber (IFSS, MPa)": (50, 50), "Shrinkage (%)": (0.1, 0.5), "Glass Transition Temperature (°C)": (225, 225), "Tensile Strength (MPa)": (60, 150), "Flexural Modulus (GPa)": (7.58, 11.3), "Density (kg/m3)": (1460, 1700)},
}
